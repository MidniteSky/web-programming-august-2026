/*
    LIVE BUILD - STEP 5 of 5: UPDATE (edit in place) - THE FILE IS COMPLETE
    =======================================================================
    read -> search -> create -> delete [UPDATE] ... done!

    CATCHING UP? Copy this ENTIRE file over members.js and you have the
    finished CRUD app. Everything marked  NEW (Step 5)  is what this final
    step adds; the rest is Steps 1-4, unchanged.
    ...
    NOTHING is "not working yet" any more. This file is the complete
    Member Manager CRUD app - all four verbs over a real REST API, plus
    live search. It's the same app as day5/starter/members.js (that copy's
    comments are written as revision notes rather than a build diary).
    Next: Bootstrap dresses it up - modals, toasts and badges - without
    changing a single verb underneath.
...
function buildRow(member) {
    ...
    function showButtons() {
        ...
        /* NEW (Step 5): the Edit button joins the family. */
    ...
    /* NEW (Step 5) --- UPDATE, move one: swap text for inputs ---
    ...
    /* NEW (Step 5) --- UPDATE, move two: change your mind ---
    ...
    /* NEW (Step 5) --- UPDATE, move three: PUT, then re-fetch ---
